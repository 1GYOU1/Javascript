...
function solution(spell, dic) {
    ...
    return result == spell.length ? 1 : 2 
}

/*
spell과 dic 배열 원소들을 sort로 오름차순 정렬해준 후,
spell과 dic 원소들을 순서대로 같이 비교했을때 같을 경우 num++ 증감시켜서
num값이 spell 배열의 길이와 같으면 return 1, 다를 경우 return 2하는 방식 사용해서 품.
*/
